...
public class StockWatcher implements EntryPoint {
	...
	private void refreshWatchList() {
		final double MAX_PRICE = 10.0; // $100.00
...
//		displayStock(symbol);
	...
	private void displayStock(final String symbol) {
		...
		removeStockButton.addStyleDependentName("remove"); //Will add -remove to gwt-Button in order to get another class called gwt-Button-remove
